...
const Interaction: NextPage<RootType> = ({ className = "" }) => {
  return (
    <div
      className={`overflow-hidden flex flex-col items-start justify-start gap-5 leading-[normal] tracking-[normal]  ${className}`}
    >
      <section className="w-full rounded-xl bg-white flex flex-col items-start justify-start p-[15px] box-border gap-[5px] min-w-[235px] max-w-[333px] text-left text-mini text-black font-plus-jakarta-sans">
        <div className="self-stretch overflow-hidden flex flex-row items-center justify-between flex-wrap content-center gap-5 text-lg font-playfair-display">
        ...
        <div className="self-stretch overflow-hidden flex flex-row items-start justify-start gap-[5px]">
          <button
            onClick={() => {}}
      ...
      <section className="w-full rounded-xl bg-white flex flex-col items-start justify-start p-[15px] box-border gap-2.5 min-w-[235px] max-w-[342px] h-grow text-left text-lg text-black font-playfair-display">
        ...
        <div className="self-stretch flex flex-col items-start justify-start pt-0 px-0 pb-[289px] gap-[5px] text-xs text-white font-plus-jakarta-sans">
          <div className="self-stretch overflow-hidden flex flex-row items-center justify-start gap-[5px]">
            <div className="rounded-2xl bg-teal overflow-hidden flex flex-col items-start justify-start py-[5px] pl-2 pr-[9px]">
              <div className="relative font-medium inline-block pl-1 min-w-[38px]">
                08:30
              </div>
            </div>
            <div className="flex-1 overflow-hidden flex flex-col items-start justify-start text-black">
              ...
              <div className="self-stretch overflow-hidden flex flex-row items-center justify-start text-2xs text-gray-300">
          ...
          <div className="self-stretch overflow-hidden flex flex-row items-center justify-start py-0 px-[30px]">
