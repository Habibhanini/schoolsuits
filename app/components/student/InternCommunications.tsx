...
const InternCommunications = () => {
  return (
    <div className="bg-white rounded-3xl p-4  max-w-3xl mx-auto h-[395px] fhd:w-full hd:w-full fhd:mr-0 lg:mr-1 ">
      {/* Header */}
      <div className="flex justify-between items-center mb-4">
        ...
        <button
          // Open the modal
          className="bg-[#3f71fb] text-white  rounded-lg py-1 px-4 text-sm font-bold hover:bg-school-blue-dark h-10"
        >
          Write a Message
        </button>
      </div>
