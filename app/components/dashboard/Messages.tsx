              ...
              <div className="flex-1">
                ...
                <div className="flex justify-between w-full">
                  <div className="flex flex-col ml-4">
                    <p className="text-orange-600 text-mini font-bold font-jakarta">
                      {message.sender}
                    </p>
                    <p className="text-mini font-semibold mb-1 font-jakarta">
                      {message.title}
                    </p>
                  </div>
                </div>
                ...
                <div className="ml-[-50px] mt-4">
                  <p className="text-mini text-gray-500 mb-2 font-jakarta">
                    {message.body}
                  </p>
